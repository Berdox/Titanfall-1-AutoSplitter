...
settings.Add("cat100", true,  "100% Training", "Select this for 100% Training category");
settings.Add("catPilot", false, "Pilot", "Select this for Pilot category");
settings.Add("catTitan", false, "Titan", "Select this for Titan category");
